  ...
  return (
    <div>
      ...
      <h3>
        ...
        logikus felépítése és az összefüggések megértése magával ragadott.{" "}
        <br />
        <br />
        Mivel művészeti iskolába jártam, jártasságot szereztem a festés,
        rajzolás és zománcozás terén is. 4. osztálytól emelt angolos osztályba
        jártam, és 8. osztály végén középfokú B2-es angol nyelvvizsgát
        szereztem. Ekkor fordult életem egy nagyot: szerettem volna a matematika
        és fizika iránti érdeklődésemet a nyelvtudással ötvözve hivatássá
        formálni. Vadászpilóta szerettem volna lenni, ezért jelentkeztem a
        Kratochvil Károly Honvéd Középiskola és Kollégiumba. Itt franciául is
        tanultam két évig, egyéb hasznos és érdekes tantárgyak mellett, mint
        például a katonai alapismeretek. Azonban rá kellett jönnöm, hogy a
      ...
      <h3>
        ...
        és a hálózati alapismeretek nehézségei eltörpültek a Python nyelven
        keresztül elsajátított programozói logika mellett. Ezzel szemben a CSS
        és a HTML gyerekjátéknak tűnt. A 2. és 3. félévben a Java programozási
        nyelvben mélyítettük el tudásunkat, emellett megismerkedtünk az
        adatbáziskezelés és az SQL világával. A HTML és CSS tanulmányainkat
        pedig JavaScript és jQuery ismeretekkel bővítettük. A 4. félévben
        megismerkedtünk a backend fejlesztéssel, Laravel keretrendszerben
        építettünk adatbázisokat, valamint React-tal foglalkoztunk a frontend
        oldalon. Megtanultuk, hogyan épül fel egy igazi weboldal, és hogyan
        működnek a REST API kérések. Az elsajátított tudásunkat szakdolgozatban
        kellett bemutatnunk, amit 2-3 fős csapatokban készítettünk el, hogy a
        csapatmunkát is gyakoroljuk. A „MyWorks” oldalon megtekinthető a
        BoozeNow szakdolgozatunk, ahol képek láthatók az elkészült szakdolgozat
        frontend oldaláról, valamint a részletes dokumentáció is elérhető.
        <br />
        <br />A szakdolgozat mellett volt egy 4 órás vizsgánk is, amely során 1
        óra backend, 1 óra frontend, 1 óra Java konzolos és 1 óra Java GUI
        feladatsort kellett teljesíteni. Az iskolát 4-es átlaggal végeztem el,
        de úgy éreztem, nem szereztem elég tudást, ezért is jelentkeztem
        egyetemre. Első helyen a Dunaújvárosi Egyetem mérnökinformatikus szakát
        jelöltem meg, ahova fel is vettek. Tanulmányaimat 2024. szeptember 1-jén
      ...
      <h3>
        ...
        konyhai munkákat és a vendégek kiszolgálását is. Minden terület más és
        ...
        feladatokkal bíztak meg. Felelős lettem az étteremben lévő főpénztárért,
        a csapatmunkáért és az élelmiszerbiztonságért. Mindhárom terület komoly
        tudást és odafigyelést igényel. A főpénztárhoz kapcsolódó feladatok közé
        tartozik a pénztár átvétele, a kasszák fel- és levétele, azok
        leszámolása, valamint minden forgalmi adat (forint, euró, utalvány,
        bankkártya) regisztrálása. Ezen kívül több fontos biztonsági szabály
        betartása is szükséges. Az élelmiszerbiztonság pedig a munkánk
        legnagyobb részét képezi. Minden egyes alapanyagnak más az
        eltarthatósági és temperálási ideje, figyelni kell az általános fogyást,
        és ennek megfelelően kell kiszámolni a szükséges alapanyag-mennyiséget.
        Se kevés, se sok nem lehet. Ezen kívül folyamatosan figyelemmel kell
        kísérni minden termék lejáratát, hiszen szigorú szabályok alapján egy
        percet sem lehet lejárt alapanyag a pályán. Nincs lehetőség hibázni,
        hiszen emberek egészsége forog kockán, ha nem megfelelően végzem a
        munkámat. Vezetőként felelős vagyok a dolgozókért is, így a főpénztár és
      ...
      <h3>
        ...
        a legmeghatározóbb a tánc volt; 13 éven keresztül táncoltam, és ez idő
        alatt tízszer vonultam fel a debreceni virágkarneválon. Emellett
        édesanyám imád utazni, így minden évben egyszer a tengerpartnál
        nyaraltunk. Ezek mellett minden időmet a tanulásnak szenteltem. 2019-ben
        örökbe fogadtam egy magyar vizslát, akit Kicsinek hívnak. Ő a hű társam
        és a legjobb barátom. Ha lehetőség van rá, minden útra magammal viszem,
        és szeretek vele túrázni, utazni. Ő a legjobb kutya a világon, és
        gyakorlatilag ő a hobbim is, mert minden szabadidőmet vele töltöm.
        <br />
        <br />
        A jövőre nézve szeretnék egy nagyobb cégnél elhelyezkedni, és a
        következő években megszerezni a diplomámat. Ezek után mesterszakon
        szeretnék továbbtanulni kiberbiztonságot, mivel rettentően érdekel ez a
        világ. Olyan cégnél szeretnék dolgozni, ahol kamatoztathatom az eddigi
        tudásomat, de lehetőséget kapok új ismeretek elsajátítására is. Legyen
        szó egyedül vagy csapatban végzett munkáról, mindkettővel el tudom érni
        a kitűzött céljaimat. Örülnék, ha lenne lehetőség otthonról dolgozni,
        vagy kutyusommal járni az irodába.
        <br />
        <br />
        Életcélom, hogy egyszer majd egy farmra költözhessek, ahol állatokat
        tarthatok, növényeket termeszthetek, és közben olyan munkát végezzek,
